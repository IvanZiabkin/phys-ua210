...
# The current inputs are unstable...? Unless variable labels + this function are wrong - Ivan
    
    # Advection velocity. Note: our curve behaves funny for negative c, but shouldn't - Ivan
    # This is likely just due to boundary conditions at the moment - Sally
    c = 1.0
